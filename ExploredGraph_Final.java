...
//                                System.out.println("item is: "+item);
		...
		public boolean equals(Object v){
			...
			// Return true when the object is compared with itself 
	        if (v == this) {
	            return true;
	        }

	        // Check if Object v is an instance of Vertex or not
	        if (!(v instanceof Vertex)) {
	            return false;
	        }

	        // Typecast Object v to Vertex to compare 
	        Vertex cast = (Vertex) v;

	        // Compare the Object v to the Vertex 
			// Return true if the strings of both Object v and the Vertex are equal, false otherwise 
